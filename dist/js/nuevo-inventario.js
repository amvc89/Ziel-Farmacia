		    ...
		    render: {
		        item: function(item, escape) {
		            ...
		            return '<div>' +
		                ...
		                (item.lab ? '<span class="ItemDetProd">Laboratorio: ' + escape(item.lab) + '</span>' : ' ') +
		            '</div>';
		        ...
		        option: function(item, escape) {
		            ...
		            return '<div>' +
		                '<span class="cboNomProd">' + escape(label) + '</span>' +
		                (caption ? '<span class="cboDetProd">' + escape(caption) + '</span>' : '') +
		            '</div>';
		        }
		    },
