...
$data_prods = array();
$data_prods = $OBJ->get_all_productos_simlex();
...
<!-- Modal -->
<div class="modal fade" id="frmProducto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <button id="addProducto" type="button" class="btn btn-primary">Agregar producto</button>
        </div>
    </div>
  </div>
</div>
