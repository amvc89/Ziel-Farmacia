        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3-col-sm-3 col-xs-12">
                    <a href="nueva-boleta.php" class=" btn btn-primary ">Nueva Boleta</a>
                </div>
                <!-- /.col -->
                <div class="col-lg-3 col-md-3-col-sm-3 col-xs-12">
                    <a href="editar-producto.php" class=" btn btn-primary ">Nuevo Producto</a>
                </div>
                <!-- /.col -->
                <div class="col-lg-3 col-md-3-col-sm-3 col-xs-12">
                    <a href="nuevo-parte-entrada.php" class=" btn btn-primary ">Nuevo Parte de entrada</a>
                </div>
                <!-- /.col -->
            </div>
            <!-- /.row -->
