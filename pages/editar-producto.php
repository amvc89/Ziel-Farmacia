				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="row">
							...
							<div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 ">
								<div class="form-group">
									<label for="cboTipo" >Tipo de Producto</label>
									<select name="cboTipo" id="cboTipo" class="form-control">
										<option value="Ninguno" <?php if( $tipo == 'Ninguno'){ echo "selected='selected'"; }  ?> >Ninguno</option>
										<option value="Marca" <?php if( $tipo == 'Marca'){ echo "selected='selected'"; }  ?> >Marca</option>
										<option value="Generico" <?php if( $tipo == 'Generico'){ echo "selected='selected'"; }  ?> >Generico</option>
									</select>
								</div>
						        <!-- /.form-group -->
							</div>
